...
```bash
conda create -n yardagebook python=3.10 geopandas shapely pyproj matplotlib pyyaml
...
```bash
mamba create -n yardagebook python=3.10 geopandas shapely pyproj matplotlib pyyaml
